...
-(NSDictionary *)dictionary{
    ...
    if(self.weekday != AHUndefinedSchedulComponent)
        [dict setObject:[NSNumber numberWithInteger:self.weekday] forKey:@"Weekday"];
...
{
    return [self scheduleWithMinute:minute hour:hour day:AHUndefinedSchedulComponent weekday:AHUndefinedSchedulComponent month:AHUndefinedSchedulComponent];
}
+(instancetype)weeklyRunOnWeekday:(NSInteger)weekday
                                      hour:(NSInteger)hour
{
    return [self scheduleWithMinute:00 hour:hour day:AHUndefinedSchedulComponent weekday:weekday month:AHUndefinedSchedulComponent];
}

+(instancetype)monthlyRunOnDay:(NSInteger)day
                                   hour:(NSInteger)hour
{
    return [self scheduleWithMinute:00 hour:hour day:day weekday:AHUndefinedSchedulComponent month:AHUndefinedSchedulComponent];
}
