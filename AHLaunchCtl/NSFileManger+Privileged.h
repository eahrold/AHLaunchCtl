...
/**
 *  An Catagory for NSFileManger that extends it to perform privileged operations using AHLaunchCtl library and 
 */
 ...
 */
-(BOOL)moveItemAtPath:(NSString*)path toPrivilegedLocation:(NSString*)location overwrite:(BOOL)overwrite error:(NSError**)error;
 ...
 *
 *  @param attributes Dictionary of attributes. Conform to NSFileManger set attribute keys
